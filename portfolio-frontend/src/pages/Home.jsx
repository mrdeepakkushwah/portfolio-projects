      ...
      <div className="bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Why Work With Me?</h2>
            <div className="grid md:grid-cols-3 gap-8 mt-12">
              ...
              <div className="p-6 rounded-lg">
                ...
                <p className="text-gray-600">Hands-on experience across various domains and technologies.</p>
              </div>
              <div className="p-6 rounded-lg">
                <div className="text-blue-600 text-4xl font-bold mb-3">24/7</div>
                <h3 className="font-semibold text-lg mb-2">Learning Mindset</h3>
                <p className="text-gray-600">Continuously updating skills with latest technologies.</p>
              </div>
            </div>
          </div>
        </section>
